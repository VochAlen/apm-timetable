...
export const AIRLINE_NAMES = {
  ...
  // ── Novo dodane (sa TGD slika) ───────────────────────────────────────────────
  KC: "Air Astana",
  PC: "Pegasus Airlines",
  XQ: "SunExpress",
  A3: "Aegean Air",
  P3: "Air Astana (P3)",     // fallback alias
};
...
export const AIRPORT_NAMES = {
  ...
  GDN: { city: "Gdansk",             airport: "Lech Wałęsa Airport",                    country: "Poland" },
  POZ: { city: "Poznan",             airport: "Poznań–Ławica Airport",                  country: "Poland" },
  RZE: { city: "Rzeszow",            airport: "Rzeszów–Jasionka Airport",               country: "Poland" },
  WRO: { city: "Wroclaw",            airport: "Copernicus Airport Wrocław",             country: "Poland" },
  ...
  MMX: { city: "Malmo",              airport: "Malmö Airport",                          country: "Sweden" },
